...
@section('title', 'AGEROUTE, demandeurs du département de ' . $zone_concernee . ' en ' . $modules->name)
@section('content')
            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        AGEROUTE, liste des demandeurs du département de {{ $zone_concernee }} en
                        {{ $modules->name }}
                    </div>
                    <div class="card-body">
                                ...
                                <table class="table table-bordered" id="table-ageroutebeneficiaires">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($individuelles as $key => $individuelle)
                                            @if (isset($individuelle) && $individuelle->zone->nom == $zone_concernee && $individuelle->module->name == $modules->name)
                                                <tr>
