            ...
            <div class="container-fluid">
                ...
                <div class="card border-success">
                    ...
                    <div class="card-body">
                        ...
                        {!! Form::open(['url' => 'agerouteindividuelles/' . $individuelle->id, 'method' => 'PATCH', 'files' => true]) !!}
                        @csrf
                        ...
                        <div class="form-row">
                            ...
                            {{-- <div class="form-group col-md-4 col-lg-4 col-xs-12 col-sm-12">
                                ...
                                @foreach ($zone as $value)
                                    <label>{{ Form::radio('zone', $value->id, in_array($value->id, $individuelleZones) ? true : false, ['class' => 'name']) }}
                                        {{ $value->nom }}</label>
                                    <br />
                                @endforeach
                                <small id="emailHelp" class="form-text text-muted">
