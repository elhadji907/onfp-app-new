            ...
            <div class="row">
                ...
                <div class="col-xl-3 col-md-6 mb-4">
                    <div class="card border-left-success shadow h-100 py-2">
                        <a class="nav-link"
                            href="{{ url('statutageroutepmr', ['$localite' => $localite_concernee,'$projet' => $projet->id,'$statut' => 'attente','pmr' => 'Oui']) }}"
                            target="_blank">
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                ...
                <div class="col-xl-3 col-md-6 mb-4">
                    <div class="card border-left-warning shadow h-100 py-2">
                        <a class="nav-link"
                            href="{{ url('statutageroutepmr', ['$localite' => $localite_concernee,'$projet' => $projet->id,'$statut' => 'rejeter','pmr' => 'Oui']) }}"
                            target="_blank">
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                ...
                <div class="col-xl-3 col-md-6 mb-4">
                    <div class="card border-left-info shadow h-100 py-2">
                        <a class="nav-link"
                            href="{{ url('statutageroutepmr', ['$localite' => $localite_concernee,'$projet' => $projet->id,'$statut' => 'accepter','pmr' => 'Oui']) }}"
                            target="_blank">
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        Agéroute - Liste des demandeurs du département de {{ $localite_concernee }} @if (isset($handicap) && $handicap == 'Oui')
                            vivants avec un handicap
                        @else
                            sans handicap
                        @endif
                    </div>
                                ...
                                <table class="table table-bordered" id="table-ageroutebeneficiaires">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($projet->individuelles as $key => $individuelle)
                                            @if (isset($individuelle) && $individuelle->localite->nom == $localite_concernee && $individuelle->handicap == $handicap)
                                                <tr>
