            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        Agéroute - Liste des demandeurs du département de {{ $localite_concernee }} avec une situation
                                ...
                                <table class="table table-bordered" id="table-ageroutebeneficiaires">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($projet->individuelles as $key => $individuelle)
                                            @if (isset($individuelle) && $individuelle->localite->nom == $localite_concernee && $individuelle->situation_economique == $situation_eco)
                                                <tr>
