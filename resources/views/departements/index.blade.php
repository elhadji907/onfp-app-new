    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="table-responsive table-departements">
                        <div align="right">
                            ...
                            <tbody>
                                ...
                                <tr> 
                                  ...
                                  <td class="d-flex align-items-baseline align-content-center">
                                      <a href="{!! url('departements/' .$departement->id. '/edit') !!}" class= 'btn btn-success btn-sm' title="modifier">
                                        <i class="far fa-edit">&nbsp;</i>
                                      </a>
                                      &nbsp;
                                      <a href="{!! url('departements/' .$departement->id) !!}" class= 'btn btn-primary btn-sm' title="voir la liste">
                                        <i class="far fa-eye">&nbsp;</i>
                                      </a>
                                      &nbsp;
                                      {!! Form::open(['method'=>'DELETE', 'url'=>'departements/' .$departement->id, 'id'=>'deleteForm', 'onsubmit' => 'return ConfirmDelete()']) !!}
