                        ...
                        <form class="user" method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label for="firstname"><b>{{ __('Prénom') }}</b>(<span
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    <label for="username"><b>{{ __('Pseudo') }}</b>(<span
                                            class="text-danger">*</span>)</label>
                                    <input id="username" type="text"
                                        class="form-control @error('username') is-invalid @enderror" name="username"
                                        placeholder="Ex: jean21" value="{{ old('username') }}" autocomplete="username"
                                        autofocus>
                                    @error('username')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                ...
                                <div class="form-group col-md-4">
                                    <label for="date_naissance"><b>{{ __('Date de naissance') }}</b>(<span
                                            class="text-danger">*</span>)</label>
                                    <input id="date_naissance" {{ $errors->has('date_r') ? 'is-invalid' : '' }}
                                        type="date" class="form-control @error('date_naissance') is-invalid @enderror"
                                        name="date_naissance" placeholder="Votre date de naissance"
                                        value="{{ old('date_naissance') }}" autocomplete="username" autofocus>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label for="password"><b>{{ __('Mot de passe') }}</b>(<span
                                            class="text-danger">*</span>)</label>
                                ...
                                <div class="form-group col-md-6">
                                    <label for="password-confirm"><b>{{ __('Mot de passe confirmation') }}</b>(<span
                                            class="text-danger">*</span>)</label>
                                    <input id="password-confirm" type="password" class="form-control"
                                        name="password_confirmation" placeholder="Répéter votre mot de passe"
                            ...
                            <div class="text-center">
                                <a class="small"
                                    href="{{ route('login') }}">{{ __("Vous avez déjà un compte? S'identifier!") }}</a>
                            </div>
                        </form>
                    </div>
                </div>
