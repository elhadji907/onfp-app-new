...
@section('title', 'ONFP - Modification filière')
@section('content')
<div class="content">
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header card-header-primary text-center">
                    ...
                    <p class="card-category">{{ ("filière") }}</p>
                </div>
                <div class="card-body">                    
                    <form method="POST" action="{{ route('filieres.update', [$filiere->id]) }}">
                        ...
                        <input type="hidden" name="_method" value="PATCH" />
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" name="name" class="form-control" id="input-name" placeholder="Filière" value="{{ old('name') ?? $filiere->name }}">
