...
@section('title', 'ONFP - Liste des filieres')
@section('content')
              ...
              <div class="card"> 
                ...
                <div class="card-body">
                      <div class="table-responsive">
                          <div align="right">
                            <a href="{{route('filieres.create')}}"><div class="btn btn-success btn-sm"><i class="fas fa-plus"></i>&nbsp;Ajouter</i></div></a>
                          </div>
                          <br />
                        <table class="table table-bordered table-striped" width="100%" cellspacing="0" id="table-filieres">
                          <thead class="table-dark">
                            <tr>
                              <th style="width:10%;">ID</th>
                               <th>{!! __("Filière") !!}</th>
                               <th style="width:20%;">{!! __("Prise en charge") !!}</th>
      ...
      $(document).ready(function () {
          $('#table-filieres').DataTable( { 
            "processing": true,
            "serverSide": true,
            "ajax": "{{route('filieres.list')}}",
            columns: [
                    { data: 'id', name: 'id' },
                    { data: 'name', name: 'name' },
                    { data: 'pcharges_count', name: 'pcharges_count' },
                ...
                "columnDefs": [
                        ...
                        url_e =  "{!! route('filieres.edit',':id')!!}".replace(':id', data.id);
                        url_d =  "{!! route('filieres.destroy',':id')!!}".replace(':id', data.id);
        ...
        $('#table-filieres').off('click', '.btn_delete_secteur').on('click', '.btn_delete_secteur',
        function() { 
