                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        @if (isset($etablissement))
                            Liste de <label class="badge badge-info">{{ $type }}</label> {{ __("prises en charge pour l'établissement") }} <label class="badge badge-info">{{ $etablissement }}</label> avec un effectif de <label
