                    ...
                    <div class="card-header">
                        ...
                        @if (isset($etablissement))
                            Liste des prises en charge pour la scolarité <label
                                class="badge badge-info">{{ $etablissement }}</label> avec un effectif de <label
                                ...
                                <tbody>
                                    @foreach ($pcharges as $pcharge)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ url('etabcountype', ['$type' => $pcharge->typedemande, '$etablissement' => $etablissement, '$effectif' => $effectif]) }}"
