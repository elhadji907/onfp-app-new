        ...
        <div class="container-fluid">
            ...
            <div class="card border-primary">
                <div class="card-header card-header-primary text-center border-primary">
                    <h3 class="card-title">{{ 'Enregistrement département' }}</h3>
                </div>
                <div class="card-body">

                    {!! Form::open(['route' => 'ageroutelocalites.store', 'method' => 'POST']) !!}
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                <strong>Département:</strong>
                                {!! Form::text('nom', null, ['placeholder' => 'Département', 'class' => 'form-control']) !!}
