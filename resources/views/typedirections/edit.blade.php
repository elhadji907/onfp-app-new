            ...
            <div class="container-fluid">
                ...
                <div class="row justify-content-center pb-2">
                    <div class="col-lg-12 margin-tb">
                        <a class="btn btn-outline-success" href="{{ route('typedirections.index') }}"> <i
                                class="fas fa-undo-alt"></i>&nbsp;Arrière</a>
                    </div>
                </div>
                <div class="card border-success">
                    <div class="card-header card-header-primary text-center border-success">
                        <h3 class="card-title">Modification type de direction</h3>
                    </div>
                    <div class="card-body">
                        {!! Form::model($typedirection, ['method' => 'PATCH', 'route' => ['typedirections.update', $typedirection->id]]) !!}
                        <div class="row">
