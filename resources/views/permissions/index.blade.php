                                        ...
                                        <tr>
                                            ...
                                            <td class="d-flex align-items-baseline align-middle">
                                                <a class="btn btn-info btn-sm"
                                                    href="{{ route('permissions.show', $permission->id) }}"><i class="far fa-eye">&nbsp;</i></a>&nbsp;
                                                @can('role-edit')
                                                    <a class="btn btn-primary btn-sm"
                                                        href="{{ route('permissions.edit', $permission->id) }}"><i class="far fa-edit">&nbsp;</i></a>
                                                @endcan
                                                &nbsp;
                                                @can('role-delete')
                                                    {!! Form::open(['method' => 'DELETE', 'route' => ['permissions.destroy', $permission->id], 'style' => 'display:inline', 'id' => 'deleteForm', 'onsubmit' => 'return ConfirmDelete()']) !!}
