...
@section('title', 'ONFP - Liste des specialites')
@section('content')
              ...
              <div class="card"> 
                ...
                <div class="card-body">
                      <div class="table-responsive">
                          <div align="right">
                            <a href="{{route('specialites.create')}}"><div class="btn btn-success btn-sm"><i class="fas fa-plus"></i>&nbsp;Ajouter</i></div></a>
                          </div>
                          <br />
                        <table class="table table-bordered table-striped" width="100%" cellspacing="0" id="table-specialites">
      ...
      $(document).ready(function () {
          $('#table-specialites').DataTable( { 
            ...
            columns: [
                ...
                "columnDefs": [
                        ...
                        url_e =  "{!! route('specialites.edit',':id')!!}".replace(':id', data.id);
                        url_d =  "{!! route('specialites.destroy',':id')!!}".replace(':id', data.id);
        ...
        $('#table-specialites').off('click', '.btn_delete_secteur').on('click', '.btn_delete_secteur',
        function() { 
