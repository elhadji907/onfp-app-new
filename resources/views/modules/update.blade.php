        ...
        <div class="container-fluid">
            ...
            <div class="card">
                ...
                <div class="card-body">
                        ...
                        <form method="POST" action="{{ action('App\Http\Controllers\ModulesController@update', $id) }}">
                           @csrf
                           <input type="hidden" name="_method" value="PATCH" /> 
                            <div class="form-row">
                            <div class="form-group col-md-12">
                                <label for="input-name"><b>{{ __("Nom du module") }}:</b></label>
                                <input type="text" name="name" class="form-control" id="input-name" placeholder="ex: primaire" value="{{ old('name') ?? $modules->name }}">
                            ...
                            <div class="form-group col-md-12">
                                <label for="input-name"><b>{{ __("Domaine") }}:</b></label>
