...
@section('title', 'AGEROUTE - Demandeurs de la commune de ' . $zone_concernee)
@section('content')
            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        Agéroute - Liste des demandeurs de la commune de {{ $zone_concernee }}
                    </div>
                    <div class="card-body">
                                ...
                                <table class="table table-bordered" id="table-ageroutebeneficiaires">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($individuelles as $key => $individuelle)
                                            @if (isset($individuelle) && $individuelle->zone->nom == $zone_concernee)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        @if (isset($individuelle->module->name))
                                                                <a class="nav-link"
                                                                    href="{{ url('listerparmodulezone', ['$projet' => $projet, '$zone' => $zone_concernee, '$module' => $individuelle->module->id]) }}"
                                                                    target="_blank">
