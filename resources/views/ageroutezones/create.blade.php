        ...
        <div class="container-fluid">
            ...
            <div class="card border-primary">
                <div class="card-header card-header-primary text-center border-primary">
                    <h3 class="card-title">{{ 'Enregistrement commune' }}</h3>
                </div>
                <div class="card-body">
                    {!! Form::open(['route' => 'ageroutezones.store', 'method' => 'POST']) !!}
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            {!! Form::label('Département :') !!}
                            {!! Form::select('departement', $projetLocalites, null, ['placeholder' => '', 'data-width' => '100%', 'class' => 'form-control', 'id' => 'departement']) !!}
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                {!! Form::text('commune', null, ['placeholder' => 'commune', 'class' => 'form-control']) !!}
                                <small id="emailHelp" class="form-text text-muted">
