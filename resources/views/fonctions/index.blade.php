                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            ...
                            <br />
                            <table class="table table-bordered" id="table-fonctions">
                                        ...
                                        <tr>
                                            ...
                                            <td class="d-flex align-items-baseline align-middle">
                                               ...
                                               {{--   <a class="btn btn-info btn-sm"
                                                    href="{{ route('fonctions.show', $fonction->id) }}"><i
                                                        class="far fa-eye">&nbsp;</i></a>  --}}
                                                &nbsp;
                                                {!! Form::open(['method' => 'DELETE', 'route' => ['fonctions.destroy', $fonction->id], 'style' => 'display:inline', 'id' => 'deleteForm', 'onsubmit' => 'return ConfirmDelete()']) !!}
