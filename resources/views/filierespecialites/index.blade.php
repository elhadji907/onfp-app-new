...
@section('title', 'ONFP - Liste des filiere specialites')
@section('content')
            ...
            <div class="col-md-10">
              ...
              <div class="card"> 
                  <div class="card-header">
                      ...
                      Liste des filiere specialites
                  </div>              
                <div class="card-body">
                      <div class="table-responsive">
                          <div align="right">
                            <a href="{{route('filierespecialites.create')}}"><div class="btn btn-success btn-sm"><i class="fas fa-plus"></i>&nbsp;Ajouter</i></div></a>
                          </div>
                          <br />
                        <table class="table table-bordered table-striped" width="100%" cellspacing="0" id="table-filierespecialites">
      ...
      $(document).ready(function () {
          $('#table-filierespecialites').DataTable( { 
            "processing": true,
            "serverSide": true,
            "ajax": "{{route('filierespecialites.list')}}",
            columns: [
                    { data: 'id', name: 'id' },
                    { data: 'name', name: 'name' },
                ...
                "columnDefs": [
                        ...
                        url_e =  "{!! route('filierespecialites.edit',':id')!!}".replace(':id', data.id);
                        url_d =  "{!! route('filierespecialites.destroy',':id')!!}".replace(':id', data.id);
        ...
        $('#table-filierespecialites').off('click', '.btn_delete_secteur').on('click', '.btn_delete_secteur',
        function() { 
