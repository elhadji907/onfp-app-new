...
@section('title', 'ONFP - Enregistrement antennes')
@section('content')
    <div class="content">
                        ...
                        <form method="POST" action="{{ url('antennes') }}">
                            ...
                            <div class="form-row">
                               ...
                               <div class="form-group col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                    <label for="input-code"><b>{{ __('Code') }}:</b></label>
                                    <input type="text" name="code" class="form-control" id="input-code"
                                        placeholder="Code antenne" value="{{ old('code') }}">
                                    <small id="emailHelp" class="form-text text-muted">
                                        @if ($errors->has('code'))
                            ...
                            <div class="form-row">
                                <div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    {!! Form::label('region') !!}
                                    {!! Form::select('regions[]', $regions, null, ['class' => 'form-control', 'multiple', 'id' => 'region']) !!}
                                    <small id="emailHelp" class="form-text text-muted">
