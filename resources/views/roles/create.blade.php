        ...
        <div class="container-fluid">
            ...
            <div class="card border-primary">
                <div class="card-header card-header-primary text-center border-primary">
                    <h3 class="card-title">{{ 'Enregistrement role' }}</h3>
                </div>
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-bordered" id="table-roles-create">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($permission as $key => $value)
                                        <tr>
                                            <td>{{ $i++ }}</td>
                                            <td><label>{{ Form::checkbox('permission[]', $value->id, false, ['class' => 'name']) }}
                                                    {{ $value->name }}</label></td>
                                        </tr>
                                    @endforeach
                                </tbody>
