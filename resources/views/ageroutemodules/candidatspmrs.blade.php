...
@section('title', 'AGEROUTE, demandeurs du département de ' . $localite->nom . ' victime de handicap : '.$handicap)
@section('content')
                                ...
                                <table class="table table-bordered" id="table-ageroutebeneficiaires">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($individuelles as $key => $individuelle)
                                            @if (isset($individuelle) && $individuelle->localite->nom == $localite->nom && $individuelle->module->name == $module && $individuelle->demandeur->user->sexe == $sexe && $individuelle->handicap == $handicap)
                                                <tr>
                                                    ...
                                                    @can('role-delete')
                                                        ...
                                                        <td>{!! $individuelle->note ?? '' !!}</td>  <td ALIGN="CENTER">
