            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        Agéroute, liste des candidats en attente en {{ $module_concernee }}
                    </div>
                    <div class="card-body">
                                ...
                                <table class="table table-bordered" id="table-ageroutebeneficiaires">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($individuelles as $key => $individuelle)
                                            @if (isset($individuelle) && $individuelle->module->name == $module_concernee && $individuelle->statut == "attente")
                                                <tr>
