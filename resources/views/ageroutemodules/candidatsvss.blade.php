                                ...
                                <table class="table table-bordered" id="table-ageroutebeneficiaires">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($individuelles as $key => $individuelle)
                                            @if (isset($individuelle) && $individuelle->localite->nom == $localite->nom && $individuelle->module->name == $module && $individuelle->demandeur->user->sexe == $sexe && $individuelle->handicap == $handicap && $individuelle->victime_social == $victime)
                                                <tr>
                                                    ...
                                                    @can('role-delete')
                                                        <td ALIGN="CENTER">
                                                            <a href="{{ url('candidatses', [
                                                                '$localite' => $localite->id,
                                                                '$projet' => $projet->id,
                                                                '$handicap' => $individuelle->handicap,
                                                                '$module' => $module,
                                                                '$sexe' => $sexe,
                                                                '$victime' => $individuelle->victime_social,
                                                                '$situation_eco' => $individuelle->situation_economique,
                                                            ]) }}"
