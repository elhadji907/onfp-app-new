...
@section('title', 'ONFP - Liste des diplomes')
@section('content')
              ...
              <div class="card"> 
                ...
                <div class="card-body">
                      <div class="table-responsive">
                          <div align="right">
                            <a href="{{route('diplomes.create')}}"><div class="btn btn-success  btn-sm"><i class="fas fa-plus"></i>&nbsp;Ajouter</i></div></a>
                          </div>
                          <br />
          ...
          $('#table-diplomes').DataTable( { 
            ...
            columns: [
                ...
                "columnDefs": [
                        ...
                        url_e =  "{!! route('diplomes.edit',':id')!!}".replace(':id', data.id);
                        url_d =  "{!! route('diplomes.destroy',':id')!!}".replace(':id', data.id);
