                                        ...
                                        <tr>
                                            ...
                                            <td class="d-flex align-items-baseline align-middle">
                                                <a class="btn btn-primary btn-sm"
                                                    href="{{ route('categories.edit', $categorie->id) }}"><i
                                                        class="far fa-edit">&nbsp;</i></a>
                                                &nbsp;
                                               {{--   <a class="btn btn-info btn-sm"
                                                    href="{{ route('categories.show', $categorie->id) }}"><i
                                                        class="far fa-eye">&nbsp;</i></a>  --}}
                                                &nbsp;
                                                {!! Form::open(['method' => 'DELETE', 'route' => ['categories.destroy', $categorie->id], 'style' => 'display:inline', 'id' => 'deleteForm', 'onsubmit' => 'return ConfirmDelete()']) !!}
