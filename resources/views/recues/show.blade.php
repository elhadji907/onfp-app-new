    ...
    <div class="container-fluid">        
                ...
                <div class="card-body">
                    {{--  <h3 class="card-title">{!! $recue->courrier->types_courrier->name !!}</h5>  --}}
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-3">
                            ...
                            {{-- @endcan --}}
                            <a href="{!! url('courriers/' . $recue->courrier->id . '/edit') !!}" title="voir les d&eacute;tails du courrier"
        ...
        <div class="card">
            <div class="card-body">
                ...
                @endforelse
                <form method="POST" action="{{ route('comments.store', $recue->courrier) }}" class="mt-3">
                    @csrf
                    <div class="form-group">
