...
@section('title', 'ONFP - Enregistrement arrondissements')
@section('content')
<div class="content">
    <div class="container col-12 col-sm-12 col-md-12 col-lg-8 col-xl-8">
        <div class="container-fluid">
            ...
            <div class="card">
                ...
                <div class="card-body">                                               
                        <form method="POST" action="{{ url('arrondissements') }}">
                           @csrf
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    <label for="input-name"><b>{{ __("Département") }}:</b></label>
                                ...
                                <div class="form-group col-md-12">
                                    <label for="input-name"><b>{{ __("Nom de l'arrondissement") }}:</b></label>
                                    <input type="text" name="nom" class="form-control" id="input-nom" placeholder="ex: industrie" value="{{ old('nom') }}">
                                    <small id="emailHelp" class="form-text text-muted">
                                            @if ($errors->has('nom'))
