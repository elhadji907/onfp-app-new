                ...
                <table method="POST" cellpadding="0" cellspacing="0">
                            ...
                            <table>
                                <tr>
                                    <td class="title">
                                        ...
                                        <img style="width:100%; max-width:100px;" class="rounded-circle w-100"
                    ...
                    <tr class="information">
                        <td colspan="2">
                            <table>
                                <tr>
                                    <td><b>{!! $employee->user->civilite . ' ' . $employee->user->firstname . ' ' . $employee->user->name !!}</b><br>
                                    ...
                                    <td>
                                        ...
                                        <b>Situation familiale : </b>{{ $employee->user->familiale->name }}<br>
                                    </td>
                                </tr>
                            </table>
                        </td>
